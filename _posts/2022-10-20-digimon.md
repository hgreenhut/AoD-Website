...
To be able to dynamically pick the max number of digimon in the group, I wanted to be able to have a custom amount of nested for loops to compare all of the digimon. I tried to write a recursive function that could do any amount of nested loops through the digimon list.
