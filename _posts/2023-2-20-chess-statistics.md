...
Obviously, statistics about games played by other players are not a good determiner of what is a good opening for **you**. What's important is how well you and your opponent know the opening, not how others perform with it. Your playing style and experience are much better metrics for deciding what openings to pick than how many games white or black won with that opening in January 2017 on Lichess. Nonetheless, analyzing such a large, detailed dataset is a great opportunity to find interesting patterns, even if those patterns won't make you a grandmaster.
